        ...
        <Routes>
          ...
          <Route element={<AuthGuard />}>
            ...
            >
              ...
              />
              <Route
                path="/pcp/suprimentos/componentes"
                element={
                  <RoleGuard module="suprimentos">
                    <ComponentesPage />
                  </RoleGuard>
              ...
              />
              <Route
                path="/pcp/suprimentos/duplicatas"
                element={
                  <RoleGuard module="suprimentos">
                    <DuplicatasPage />
                  </RoleGuard>
              ...
              />
              <Route
                path="/pcp/suprimentos/fornecedores"
                element={
                  <RoleGuard module="suprimentos">
                    <FornecedoresPage />
                  </RoleGuard>
              ...
              />
              <Route
                path="/pcp/suprimentos/destino-materiais"
                element={
                  <RoleGuard module="suprimentos">
                    <CentralDestinoPage />
                  </RoleGuard>
